...
class MusicPlayer:
  ...
  def __init__(self,root):
    ...
    #icon
    #self.root.iconbitmap(r'E:/new nolae/n1.ico')
    # Window Geometry
    ...
    but = Button(songsframe, text='play on yt',command=playonyt,bg='#F1FFC4',fg='black',relief=FLAT)
    ...
    selectbtn = Button(self.status_bar,text="SELECT",command=self.selectfolder,width=5,height=1,font=("Fixedsys",4,"bold"),
                    fg="black",bg="#F1FFC4",relief=FLAT, activebackground="#FFCAAF").grid(row=0,column=4,padx=2,pady=2)
